...
if __name__ == "__main__":
    ...
    while True:
        ...
        ar1 = stereo_cam.cam1.find_aruco(ARUCO_PEN_ID, grab=False,
                                         aruco_dict=ARUCO_DICT, aruco_param=ARUCO_PARAM)
        ar2 = stereo_cam.cam2.find_aruco(ARUCO_PEN_ID, grab=False,
                                         aruco_dict=ARUCO_DICT, aruco_param=ARUCO_PARAM)
        ...
        if cv.getWindowProperty('main', cv.WND_PROP_VISIBLE) < 1: break;
